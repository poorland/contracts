...
contract PoorLandMetaverse is ERC721A, Ownable {
    ...
    address private _poorlandMaterialContract = 0x045737619bb0FE286FFB8c9C81117bC4aB5C997f;
    ...
    function updateMaterialContract(address addr) external onlyOwner {
        _poorlandMaterialContract = addr;
    }
